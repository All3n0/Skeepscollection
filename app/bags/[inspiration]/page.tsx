  ...
  useEffect(() => {
    if (inspiration) {
      ...
      fetch(`http://localhost:5555/bags/inspiration/${inspiration}`)
        ...
        .catch((err) => console.error('Error fetching inspiration bags:', err))
      ...
      <main className="flex-grow max-w-7xl mx-auto px-4 py-12 w-full">
        <div className="mb-10">
          ...
          <div className="text-center">
            <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-3 capitalize">
              {inspiration} <span className="text-red-600">Bags</span>
            </h1>
            <p className="text-gray-600 max-w-2xl mx-auto">
              Discover our curated collection of {inspiration.toLowerCase()} bags to complement your style
            </p>
          </div>
        </div>
        ...
        {isLoading ? (
          ...
          <div className="text-center py-20">
            ...
            <p className="mt-1 text-gray-600">We couldn't find any bags matching "{inspiration}"</p>
          </div>
        )}
      </main>
